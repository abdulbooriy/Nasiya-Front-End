...
const EditHistory: React.FC<EditHistoryProps> = ({ editHistory }) => {
  ...
  // ✅ YANGI: Qiymatni to'g'ri formatlash (sana yoki raqam)
                          ...
                          <TableRow key={idx}>
                            ...
                            <TableCell align="right">
                              <Chip
                                ...
                                size="small"
                                color={
                                  change.difference > 0 ? "success" : change.difference < 0 ? "error" : "default"
                                }
                              />
                            </TableCell>
                          </TableRow>
